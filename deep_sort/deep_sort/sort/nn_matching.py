...
def _cosine_distance(a, b, data_is_normalized=False):   # 求余弦距离
...
def _nn_euclidean_distance(x, y):        # 欧式距离求两点的紧邻距离
...
def _nn_cosine_distance(x, y):          # 余弦距离求两点的近邻距离
